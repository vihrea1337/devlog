...
вкладка отчётов, правка отчёта и календарь дат; вёрстка панели GitHub (скриншот превью
снять не успели).
...
4. ~~Мелочи по Android: правка текста отчёта, выбор дат календарём~~ — сделано 14.08,
   ждёт живой проверки на телефоне.
