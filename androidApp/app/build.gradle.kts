...
dependencies {
    // Общий модуль: модели обмена с сервером. Одно определение на бэкенд и приложение —
    // раньше эти же классы дублировались здесь, и добавленное на сервере поле легко
    // было забыть в приложении.
