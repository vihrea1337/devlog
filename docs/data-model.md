...
`jsonb` — тип PostgreSQL для хранения JSON (массивы шагов/тегов и т.п.).
...
| steps | jsonb | массив строк-шагов |
| decisions | jsonb | массив принятых решений |
| problems | jsonb | массив решённых проблем |
